  ...
  return (
    <div className="mx-auto w-full max-w-[1200px] max-lg:px-2 my-30">
      <div className="rounded-[20px] bg-[#1A367C]">
        ...
        >
          <p className="bg-gradient-to-b from-[#fff] to-[#BDC7E1] bg-clip-text sm:text-[50px] text-[25px] text-white">
            {t.contact_comp.title}
          </p>
          <p className="mx-auto w-full max-w-[350px] sm:text-[20px] text-[16px] text-[#8DA1D0]">
            {t.contact_comp.desc}
          </p>
