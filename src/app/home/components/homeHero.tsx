    ...
    <div className="relative overflow-hidden lg:h-[800px] md:h-[750px] h-[500px]">
      <div className="relative md:h-[700px] h-[500px] ">
        ...
        <img
          ...
          className="absolute bottom-0 -z-50 h-[50%] w-full object-bottom opacity-70"
        />

        <div className="absolute -z-50 h-[70%] w-full bg-gradient-to-t from-[#ffffff] to-[#c3d9f8] shadow-[0px_60px_50px_#fff]">
      ...
      <img
        src={baklashka}
        alt="right image"
        className="absolute max-md:hidden lg:top-10 md:top-80 top-65 xl:-right-70 lg:-right-50 right-10 -z-50 xl:w-[1300px] lg:w-[800px] max-lg:max-w-[700px] w-full  object-cover"
      />
    </div>
  );
}
