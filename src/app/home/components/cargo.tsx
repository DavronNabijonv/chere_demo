    ...
    >
      <div className="relative flex items-center max-md:flex-wrap mx-auto max-w-[1200px] px-2 max-md:gap-10">
        <div className="flex flex-col items-start gap-5">
          ...
          <HashLink smooth to={`${pathName.pathname}#contact`} className=" hover:cursor-pointer items-center gap-3 rounded-[100px] border-2 border-white bg-linear-to-r from-[#1A367C] to-[#AF8C4B] p-2 px-6 text-[16px] text-white flex">
